...
@onready var blocos = [$Bloco6, $Bloco2,$Bloco2_1, $Bloco3, $Bloco5]
@onready var bau5 = $chest5
@onready var bau6 = $chest6
@onready var bau7 = $chest7
@onready var npc = $npc
...
func _ready() -> void:
	...
	elif not bau5.has_signal("block_deposited"):
		print("Erro: 'chest5' não tem o sinal 'block_deposited'!")
	if not bau6:
		print("Erro: 'chest6' não encontrado na cena!")
	elif not bau6.has_signal("block_deposited"):
		print("Erro: 'chest6' não tem o sinal 'block_deposited'!")
	if not bau7:
		print("Erro: 'chest7' não encontrado na cena!")
	elif not bau7.has_signal("block_deposited"):
		print("Erro: 'chest7' não tem o sinal 'block_deposited'!")
	...
	if bau5 and npc and bau5.has_signal("block_deposited") and npc.has_method("_on_block_deposited"):
		bau5.block_deposited.connect(npc._on_block_deposited)
		bau5.block_deposited.connect(_on_bau5_deposited)
		print("Conexões de 'chest5' realizadas com sucesso!")
	else:
		print("Falha ao conectar 'chest9' - Verifique baú ou NPC!")

	if bau6 and npc2 and bau6.has_signal("block_deposited") and npc2.has_method("_on_block_deposited"):
		bau6.block_deposited.connect(npc2._on_block_deposited)
		bau6.block_deposited.connect(_on_bau6_deposited)
		print("Conexões de 'chest8' realizadas com sucesso!")
	else:
		print("Falha ao conectar 'chest8' - Verifique baú ou NPC!")

	if bau7 and npc3 and bau7.has_signal("block_deposited") and npc3.has_method("_on_block_deposited"):
		bau7.block_deposited.connect(npc3._on_block_deposited)
		bau7.block_deposited.connect(_on_bau7_deposited)
		print("Conexões de 'chest5' realizadas com sucesso!")
	else:
...
func _on_bau5_deposited():
	print("Baú 5 ativado!")

func _on_bau6_deposited():
	print("Baú 6 ativado!")

func _on_bau7_deposited():
	print("Baú 7 ativado!")
