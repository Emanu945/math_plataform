...
func _ready() -> void:
	...
	elif not bau9.has_signal("block_deposited"):
	...
	if bau9 and npc and bau9.has_signal("block_deposited") and npc.has_method("_on_block_deposited"):
	...
	if bau8 and npc2 and bau8.has_signal("block_deposited") and npc2.has_method("_on_block_deposited"):
		bau8.block_deposited.connect(npc2._on_block_deposited)
	...
	if bau5 and npc3 and bau5.has_signal("block_deposited") and npc3.has_method("_on_block_deposited"):
		bau5.block_deposited.connect(npc3._on_block_deposited)
